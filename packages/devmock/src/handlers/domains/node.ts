...
const workerAssets = db<MockWorkerAsset>('worker-assets', () => [
  {
    ...
    size: 1024 * 1024,
    sourceUrl: 'https://github.com/wcpe/JianManager/releases/download/v0.10.0/worker-linux-amd64',
  ...
  },
  {
    ...
    sha256: '',
    size: 0,
    sourceUrl: 'https://github.com/wcpe/JianManager/releases/download/v0.10.0/worker-windows-amd64.exe',
    cachedAt: '',
...
function cacheWorkerAsset(os: string, arch: string) {
  ...
  const patch = {
    ...
    size: 2 * 1024 * 1024,
    sourceUrl: `https://github.com/wcpe/JianManager/releases/download/v0.10.0/worker-${os}-${arch}`,
