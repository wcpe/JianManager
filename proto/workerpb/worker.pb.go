...
const file_proto_worker_proto_rawDesc = "" +
	...
	"\aresults\x18\x02 \x03(\v2*.worker.CancelBotCommandScheduleItemResultR\aresults2\x98:\n" +
	"\rWorkerService\x12=\n" +
...
var file_proto_worker_proto_msgTypes = make([]protoimpl.MessageInfo, 226)
var file_proto_worker_proto_goTypes = []any{
	...
	(*SendCommandRequest)(nil),                  // 22: worker.SendCommandRequest
	(*SendCommandResponse)(nil),                 // 23: worker.SendCommandResponse
	(*GetInstanceStatusResponse)(nil),           // 24: worker.GetInstanceStatusResponse
	(*ListInstancesRequest)(nil),                // 25: worker.ListInstancesRequest
	(*ListInstancesResponse)(nil),               // 26: worker.ListInstancesResponse
	(*InstanceInfo)(nil),                        // 27: worker.InstanceInfo
	(*StreamInstanceEventsRequest)(nil),         // 28: worker.StreamInstanceEventsRequest
	(*InstanceEvent)(nil),                       // 29: worker.InstanceEvent
	(*IssueTerminalTokenRequest)(nil),           // 30: worker.IssueTerminalTokenRequest
	(*IssueTerminalTokenResponse)(nil),          // 31: worker.IssueTerminalTokenResponse
	(*ListFilesRequest)(nil),                    // 32: worker.ListFilesRequest
	(*ListFilesResponse)(nil),                   // 33: worker.ListFilesResponse
	(*FileInfo)(nil),                            // 34: worker.FileInfo
	(*CheckPathAccessRequest)(nil),              // 35: worker.CheckPathAccessRequest
	(*CheckPathAccessResponse)(nil),             // 36: worker.CheckPathAccessResponse
	(*ChmodPathRequest)(nil),                    // 37: worker.ChmodPathRequest
	(*ChmodPathResponse)(nil),                   // 38: worker.ChmodPathResponse
	(*ReadFileRequest)(nil),                     // 39: worker.ReadFileRequest
	(*ReadFileResponse)(nil),                    // 40: worker.ReadFileResponse
	(*WriteFileRequest)(nil),                    // 41: worker.WriteFileRequest
	(*WriteFileResponse)(nil),                   // 42: worker.WriteFileResponse
	(*DeleteFileRequest)(nil),                   // 43: worker.DeleteFileRequest
	(*DeleteFileResponse)(nil),                  // 44: worker.DeleteFileResponse
	(*RenameFileRequest)(nil),                   // 45: worker.RenameFileRequest
	(*RenameFileResponse)(nil),                  // 46: worker.RenameFileResponse
	(*DownloadArchiveRequest)(nil),              // 47: worker.DownloadArchiveRequest
	(*DownloadArchiveChunk)(nil),                // 48: worker.DownloadArchiveChunk
	(*DownloadFileRequest)(nil),                 // 49: worker.DownloadFileRequest
	(*DownloadFileChunk)(nil),                   // 50: worker.DownloadFileChunk
	(*UploadFileChunk)(nil),                     // 51: worker.UploadFileChunk
	(*UploadFileResponse)(nil),                  // 52: worker.UploadFileResponse
	(*SearchFilesRequest)(nil),                  // 53: worker.SearchFilesRequest
	(*SearchHit)(nil),                           // 54: worker.SearchHit
	(*SearchFilesResponse)(nil),                 // 55: worker.SearchFilesResponse
	(*ListConfigFilesRequest)(nil),              // 56: worker.ListConfigFilesRequest
	(*ConfigFileInfo)(nil),                      // 57: worker.ConfigFileInfo
	(*ListConfigFilesResponse)(nil),             // 58: worker.ListConfigFilesResponse
	(*ConfigField)(nil),                         // 59: worker.ConfigField
	(*ValidationIssue)(nil),                     // 60: worker.ValidationIssue
	(*ConfigValidationResult)(nil),              // 61: worker.ConfigValidationResult
	(*ReadConfigRequest)(nil),                   // 62: worker.ReadConfigRequest
	(*ReadConfigResponse)(nil),                  // 63: worker.ReadConfigResponse
	(*WriteConfigRequest)(nil),                  // 64: worker.WriteConfigRequest
	(*WriteConfigResponse)(nil),                 // 65: worker.WriteConfigResponse
	(*ValidateConfigRequest)(nil),               // 66: worker.ValidateConfigRequest
	(*ValidateConfigResponse)(nil),              // 67: worker.ValidateConfigResponse
	(*DiffConfigRequest)(nil),                   // 68: worker.DiffConfigRequest
	(*DiffConfigResponse)(nil),                  // 69: worker.DiffConfigResponse
	(*GetNodeMetricsRequest)(nil),               // 70: worker.GetNodeMetricsRequest
	(*GetNodeMetricsResponse)(nil),              // 71: worker.GetNodeMetricsResponse
	(*GetInstanceMetricsRequest)(nil),           // 72: worker.GetInstanceMetricsRequest
	(*GetInstanceMetricsResponse)(nil),          // 73: worker.GetInstanceMetricsResponse
	(*GetInstanceResourceSnapshotRequest)(nil),  // 74: worker.GetInstanceResourceSnapshotRequest
	(*GetInstanceResourceSnapshotResponse)(nil), // 75: worker.GetInstanceResourceSnapshotResponse
	(*WorldMetric)(nil),                         // 76: worker.WorldMetric
	(*GetInstanceEnvRequest)(nil),               // 77: worker.GetInstanceEnvRequest
	(*GetInstanceEnvResponse)(nil),              // 78: worker.GetInstanceEnvResponse
	(*CreateBotRequest)(nil),                    // 79: worker.CreateBotRequest
	(*CreateBotResponse)(nil),                   // 80: worker.CreateBotResponse
	(*DeleteBotRequest)(nil),                    // 81: worker.DeleteBotRequest
	(*DeleteBotResponse)(nil),                   // 82: worker.DeleteBotResponse
	(*ListBotsRequest)(nil),                     // 83: worker.ListBotsRequest
	(*ListBotsResponse)(nil),                    // 84: worker.ListBotsResponse
	(*BotInfo)(nil),                             // 85: worker.BotInfo
	(*SetBotBehaviorRequest)(nil),               // 86: worker.SetBotBehaviorRequest
	(*SetBotBehaviorResponse)(nil),              // 87: worker.SetBotBehaviorResponse
	(*SendBotCommandRequest)(nil),               // 88: worker.SendBotCommandRequest
	(*SendBotCommandResponse)(nil),              // 89: worker.SendBotCommandResponse
	(*RunBotScriptRequest)(nil),                 // 90: worker.RunBotScriptRequest
	(*RunBotScriptResponse)(nil),                // 91: worker.RunBotScriptResponse
	(*StreamBotEventsRequest)(nil),              // 92: worker.StreamBotEventsRequest
	(*BotEvent)(nil),                            // 93: worker.BotEvent
	(*ListJDKsRequest)(nil),                     // 94: worker.ListJDKsRequest
	(*JDKInfo)(nil),                             // 95: worker.JDKInfo
	(*ListJDKsResponse)(nil),                    // 96: worker.ListJDKsResponse
	(*InstallJDKRequest)(nil),                   // 97: worker.InstallJDKRequest
	(*JDKCatalogRequest)(nil),                   // 98: worker.JDKCatalogRequest
	(*JDKCatalogPackage)(nil),                   // 99: worker.JDKCatalogPackage
	(*JDKCatalogResponse)(nil),                  // 100: worker.JDKCatalogResponse
	(*InstallJDKResponse)(nil),                  // 101: worker.InstallJDKResponse
	(*RemoveJDKRequest)(nil),                    // 102: worker.RemoveJDKRequest
	(*RemoveJDKResponse)(nil),                   // 103: worker.RemoveJDKResponse
	(*DownloadCoreRequest)(nil),                 // 104: worker.DownloadCoreRequest
	(*DownloadCoreResponse)(nil),                // 105: worker.DownloadCoreResponse
	(*InstallForgeServerRequest)(nil),           // 106: worker.InstallForgeServerRequest
	(*InstallForgeServerResponse)(nil),          // 107: worker.InstallForgeServerResponse
	(*ArtifactCacheItem)(nil),                   // 108: worker.ArtifactCacheItem
	(*ListArtifactCacheRequest)(nil),            // 109: worker.ListArtifactCacheRequest
	(*ListArtifactCacheResponse)(nil),           // 110: worker.ListArtifactCacheResponse
	(*EvictArtifactCacheRequest)(nil),           // 111: worker.EvictArtifactCacheRequest
	(*EvictArtifactCacheResponse)(nil),          // 112: worker.EvictArtifactCacheResponse
	(*ClearArtifactCacheRequest)(nil),           // 113: worker.ClearArtifactCacheRequest
	(*ClearArtifactCacheResponse)(nil),          // 114: worker.ClearArtifactCacheResponse
	(*SetArtifactCacheCapRequest)(nil),          // 115: worker.SetArtifactCacheCapRequest
	(*SetArtifactCacheCapResponse)(nil),         // 116: worker.SetArtifactCacheCapResponse
	(*BrowseDirRequest)(nil),                    // 117: worker.BrowseDirRequest
	(*BrowseDirEntry)(nil),                      // 118: worker.BrowseDirEntry
	(*BrowseDirResponse)(nil),                   // 119: worker.BrowseDirResponse
	(*ProbeJDKRequest)(nil),                     // 120: worker.ProbeJDKRequest
	(*ProbeJDKResponse)(nil),                    // 121: worker.ProbeJDKResponse
	(*ScanRuntimesRequest)(nil),                 // 122: worker.ScanRuntimesRequest
	(*RuntimeCandidate)(nil),                    // 123: worker.RuntimeCandidate
	(*ScanRuntimesResponse)(nil),                // 124: worker.ScanRuntimesResponse
	(*InstallRuntimeRequest)(nil),               // 125: worker.InstallRuntimeRequest
	(*InstallRuntimeResponse)(nil),              // 126: worker.InstallRuntimeResponse
	(*RemoveRuntimeRequest)(nil),                // 127: worker.RemoveRuntimeRequest
	(*RemoveRuntimeResponse)(nil),               // 128: worker.RemoveRuntimeResponse
	(*PMRegistry)(nil),                          // 129: worker.PMRegistry
	(*GetPMConfigRequest)(nil),                  // 130: worker.GetPMConfigRequest
	(*GetPMConfigResponse)(nil),                 // 131: worker.GetPMConfigResponse
	(*SetPMConfigRequest)(nil),                  // 132: worker.SetPMConfigRequest
	(*SetPMConfigResponse)(nil),                 // 133: worker.SetPMConfigResponse
	(*GlobalPackage)(nil),                       // 134: worker.GlobalPackage
	(*ListGlobalPackagesRequest)(nil),           // 135: worker.ListGlobalPackagesRequest
	(*ListGlobalPackagesResponse)(nil),          // 136: worker.ListGlobalPackagesResponse
	(*InstallGlobalPackageRequest)(nil),         // 137: worker.InstallGlobalPackageRequest
	(*InstallGlobalPackageResponse)(nil),        // 138: worker.InstallGlobalPackageResponse
	(*RemoveGlobalPackageRequest)(nil),          // 139: worker.RemoveGlobalPackageRequest
	(*RemoveGlobalPackageResponse)(nil),         // 140: worker.RemoveGlobalPackageResponse
	(*DeployServerProbeRequest)(nil),            // 141: worker.DeployServerProbeRequest
	(*DeployServerProbeResponse)(nil),           // 142: worker.DeployServerProbeResponse
	(*CloneWorkDirRequest)(nil),                 // 143: worker.CloneWorkDirRequest
	(*CloneWorkDirResponse)(nil),                // 144: worker.CloneWorkDirResponse
	(*RemoveInstanceRequest)(nil),               // 145: worker.RemoveInstanceRequest
	(*RemoveInstanceResponse)(nil),              // 146: worker.RemoveInstanceResponse
	(*ListImagesRequest)(nil),                   // 147: worker.ListImagesRequest
	(*ImageInfo)(nil),                           // 148: worker.ImageInfo
	(*ListImagesResponse)(nil),                  // 149: worker.ListImagesResponse
	(*PullImageRequest)(nil),                    // 150: worker.PullImageRequest
	(*PullImageResponse)(nil),                   // 151: worker.PullImageResponse
	(*RemoveImageRequest)(nil),                  // 152: worker.RemoveImageRequest
	(*RemoveImageResponse)(nil),                 // 153: worker.RemoveImageResponse
	(*StorageBackendSpec)(nil),                  // 154: worker.StorageBackendSpec
	(*BackupManifestEntry)(nil),                 // 155: worker.BackupManifestEntry
	(*CreateBackupRequest)(nil),                 // 156: worker.CreateBackupRequest
	(*CreateBackupResponse)(nil),                // 157: worker.CreateBackupResponse
	(*RestoreBackupRequest)(nil),                // 158: worker.RestoreBackupRequest
	(*RestoreBackupResponse)(nil),               // 159: worker.RestoreBackupResponse
	(*TestStorageBackendRequest)(nil),           // 160: worker.TestStorageBackendRequest
	(*TestStorageBackendResponse)(nil),          // 161: worker.TestStorageBackendResponse
	(*StreamPluginEventsRequest)(nil),           // 162: worker.StreamPluginEventsRequest
	(*PluginEvent)(nil),                         // 163: worker.PluginEvent
	(*PluginCommand)(nil),                       // 164: worker.PluginCommand
	(*SendPluginCommandRequest)(nil),            // 165: worker.SendPluginCommandRequest
	(*SendPluginCommandResponse)(nil),           // 166: worker.SendPluginCommandResponse
	(*QueryServerStateRequest)(nil),             // 167: worker.QueryServerStateRequest
	(*QueryServerStateResponse)(nil),            // 168: worker.QueryServerStateResponse
	(*GetVersionRequest)(nil),                   // 169: worker.GetVersionRequest
	(*GetVersionResponse)(nil),                  // 170: worker.GetVersionResponse
	(*CheckDockerRequest)(nil),                  // 171: worker.CheckDockerRequest
	(*CheckDockerResponse)(nil),                 // 172: worker.CheckDockerResponse
	(*UpgradeWorkerRequest)(nil),                // 173: worker.UpgradeWorkerRequest
	(*UpgradeWorkerResponse)(nil),               // 174: worker.UpgradeWorkerResponse
	(*ListArchiveEntriesRequest)(nil),           // 175: worker.ListArchiveEntriesRequest
	(*ArchiveEntry)(nil),                        // 176: worker.ArchiveEntry
	(*ListArchiveEntriesResponse)(nil),          // 177: worker.ListArchiveEntriesResponse
	(*ReadArchiveEntryRequest)(nil),             // 178: worker.ReadArchiveEntryRequest
	(*ReadArchiveEntryResponse)(nil),            // 179: worker.ReadArchiveEntryResponse
	(*DecompileClassRequest)(nil),               // 180: worker.DecompileClassRequest
	(*DecompileClassResponse)(nil),              // 181: worker.DecompileClassResponse
	(*TerminalFrame)(nil),                       // 182: worker.TerminalFrame
	(*TerminalOpen)(nil),                        // 183: worker.TerminalOpen
	(*TerminalWSFrame)(nil),                     // 184: worker.TerminalWSFrame
	(*InspectServerDirRequest)(nil),             // 185: worker.InspectServerDirRequest
	(*ImportJarCandidate)(nil),                  // 186: worker.ImportJarCandidate
	(*ImportJdkCandidate)(nil),                  // 187: worker.ImportJdkCandidate
	(*InspectServerDirResponse)(nil),            // 188: worker.InspectServerDirResponse
	(*ImportServerDirRequest)(nil),              // 189: worker.ImportServerDirRequest
	(*ImportServerDirResponse)(nil),             // 190: worker.ImportServerDirResponse
	(*GetBotCapacityRequest)(nil),               // 191: worker.GetBotCapacityRequest
	(*GetBotCapacityResponse)(nil),              // 192: worker.GetBotCapacityResponse
	(*BotAssignment)(nil),                       // 193: worker.BotAssignment
	(*ApplyBotBatchRequest)(nil),                // 194: worker.ApplyBotBatchRequest
	(*ApplyBotBatchItemResult)(nil),             // 195: worker.ApplyBotBatchItemResult
	(*ApplyBotBatchResponse)(nil),               // 196: worker.ApplyBotBatchResponse
	(*GetBotFleetSnapshotRequest)(nil),          // 197: worker.GetBotFleetSnapshotRequest
	(*BotPosition)(nil),                         // 198: worker.BotPosition
	(*BotRuntimeSnapshot)(nil),                  // 199: worker.BotRuntimeSnapshot
	(*GetBotFleetSnapshotResponse)(nil),         // 200: worker.GetBotFleetSnapshotResponse
	(*StreamBotFleetEventsRequest)(nil),         // 201: worker.StreamBotFleetEventsRequest
	(*BotActionEvent)(nil),                      // 202: worker.BotActionEvent
	(*BotFleetEvent)(nil),                       // 203: worker.BotFleetEvent
	(*BotActionSignal)(nil),                     // 204: worker.BotActionSignal
	(*SignalBotActionsRequest)(nil),             // 205: worker.SignalBotActionsRequest
	(*SignalBotActionItemResult)(nil),           // 206: worker.SignalBotActionItemResult
	(*SignalBotActionsResponse)(nil),            // 207: worker.SignalBotActionsResponse
	(*CommandOccurrenceKey)(nil),                // 208: worker.CommandOccurrenceKey
	(*CommandOccurrenceRef)(nil),                // 209: worker.CommandOccurrenceRef
	(*AppliedCommandOccurrence)(nil),            // 210: worker.AppliedCommandOccurrence
	(*AppliedCommandOccurrencePlan)(nil),        // 211: worker.AppliedCommandOccurrencePlan
	(*ApplyBotCommandScheduleItem)(nil),         // 212: worker.ApplyBotCommandScheduleItem
	(*ApplyBotCommandScheduleItemResult)(nil),   // 213: worker.ApplyBotCommandScheduleItemResult
	(*ApplyBotCommandSchedulesRequest)(nil),     // 214: worker.ApplyBotCommandSchedulesRequest
	(*ApplyBotCommandSchedulesResponse)(nil),    // 215: worker.ApplyBotCommandSchedulesResponse
	(*ReleaseBotCommandScheduleItem)(nil),       // 216: worker.ReleaseBotCommandScheduleItem
	(*ReleaseBotCommandScheduleItemResult)(nil), // 217: worker.ReleaseBotCommandScheduleItemResult
	(*ReleaseBotCommandSchedulesRequest)(nil),   // 218: worker.ReleaseBotCommandSchedulesRequest
	(*ReleaseBotCommandSchedulesResponse)(nil),  // 219: worker.ReleaseBotCommandSchedulesResponse
	(*CancelBotCommandScheduleItem)(nil),        // 220: worker.CancelBotCommandScheduleItem
	(*CancelBotCommandScheduleItemResult)(nil),  // 221: worker.CancelBotCommandScheduleItemResult
	(*CancelBotCommandSchedulesRequest)(nil),    // 222: worker.CancelBotCommandSchedulesRequest
	(*CancelBotCommandSchedulesResponse)(nil),   // 223: worker.CancelBotCommandSchedulesResponse
	nil, // 224: worker.CreateInstanceRequest.EnvVarsEntry
	nil, // 225: worker.GetInstanceEnvResponse.EnvEntry
}
var file_proto_worker_proto_depIdxs = []int32{
	...
	76,  // 5: worker.InstanceMetricSample.worlds:type_name -> worker.WorldMetric
	224, // 6: worker.CreateInstanceRequest.env_vars:type_name -> worker.CreateInstanceRequest.EnvVarsEntry
	...
	27,  // 9: worker.ListInstancesResponse.instances:type_name -> worker.InstanceInfo
	34,  // 10: worker.ListFilesResponse.files:type_name -> worker.FileInfo
	54,  // 11: worker.SearchFilesResponse.hits:type_name -> worker.SearchHit
	57,  // 12: worker.ListConfigFilesResponse.files:type_name -> worker.ConfigFileInfo
	60,  // 13: worker.ConfigValidationResult.issues:type_name -> worker.ValidationIssue
	59,  // 14: worker.ReadConfigResponse.fields:type_name -> worker.ConfigField
	61,  // 15: worker.ReadConfigResponse.validation:type_name -> worker.ConfigValidationResult
	59,  // 16: worker.WriteConfigRequest.fields:type_name -> worker.ConfigField
	61,  // 17: worker.WriteConfigResponse.validation:type_name -> worker.ConfigValidationResult
	61,  // 18: worker.ValidateConfigResponse.validation:type_name -> worker.ConfigValidationResult
	76,  // 19: worker.GetInstanceMetricsResponse.worlds:type_name -> worker.WorldMetric
	225, // 20: worker.GetInstanceEnvResponse.env:type_name -> worker.GetInstanceEnvResponse.EnvEntry
	85,  // 21: worker.ListBotsResponse.bots:type_name -> worker.BotInfo
	95,  // 22: worker.ListJDKsResponse.jdks:type_name -> worker.JDKInfo
	99,  // 23: worker.JDKCatalogResponse.packages:type_name -> worker.JDKCatalogPackage
	95,  // 24: worker.InstallJDKResponse.jdk:type_name -> worker.JDKInfo
	108, // 25: worker.ListArtifactCacheResponse.items:type_name -> worker.ArtifactCacheItem
	118, // 26: worker.BrowseDirResponse.dirs:type_name -> worker.BrowseDirEntry
	123, // 27: worker.ScanRuntimesResponse.candidates:type_name -> worker.RuntimeCandidate
	129, // 28: worker.GetPMConfigResponse.registries:type_name -> worker.PMRegistry
	129, // 29: worker.SetPMConfigRequest.registries:type_name -> worker.PMRegistry
	134, // 30: worker.ListGlobalPackagesResponse.packages:type_name -> worker.GlobalPackage
	148, // 31: worker.ListImagesResponse.images:type_name -> worker.ImageInfo
	155, // 32: worker.CreateBackupRequest.base_manifest:type_name -> worker.BackupManifestEntry
	154, // 33: worker.CreateBackupRequest.storage:type_name -> worker.StorageBackendSpec
	155, // 34: worker.CreateBackupResponse.manifest:type_name -> worker.BackupManifestEntry
	154, // 35: worker.RestoreBackupRequest.storage:type_name -> worker.StorageBackendSpec
	154, // 36: worker.TestStorageBackendRequest.storage:type_name -> worker.StorageBackendSpec
	164, // 37: worker.SendPluginCommandRequest.command:type_name -> worker.PluginCommand
	176, // 38: worker.ListArchiveEntriesResponse.entries:type_name -> worker.ArchiveEntry
	183, // 39: worker.TerminalFrame.open:type_name -> worker.TerminalOpen
	184, // 40: worker.TerminalFrame.frame:type_name -> worker.TerminalWSFrame
	186, // 41: worker.InspectServerDirResponse.jars:type_name -> worker.ImportJarCandidate
	187, // 42: worker.InspectServerDirResponse.jdks:type_name -> worker.ImportJdkCandidate
	193, // 43: worker.ApplyBotBatchRequest.assignments:type_name -> worker.BotAssignment
	195, // 44: worker.ApplyBotBatchResponse.results:type_name -> worker.ApplyBotBatchItemResult
	198, // 45: worker.BotRuntimeSnapshot.pos:type_name -> worker.BotPosition
	199, // 46: worker.GetBotFleetSnapshotResponse.bots:type_name -> worker.BotRuntimeSnapshot
	199, // 47: worker.BotFleetEvent.runtime_snapshot:type_name -> worker.BotRuntimeSnapshot
	202, // 48: worker.BotFleetEvent.action_event:type_name -> worker.BotActionEvent
	204, // 49: worker.SignalBotActionsRequest.signals:type_name -> worker.BotActionSignal
	206, // 50: worker.SignalBotActionsResponse.results:type_name -> worker.SignalBotActionItemResult
	210, // 51: worker.AppliedCommandOccurrencePlan.occurrences:type_name -> worker.AppliedCommandOccurrence
	211, // 52: worker.ApplyBotCommandScheduleItem.plan:type_name -> worker.AppliedCommandOccurrencePlan
	208, // 53: worker.ApplyBotCommandScheduleItem.skip_occurrences:type_name -> worker.CommandOccurrenceKey
	212, // 54: worker.ApplyBotCommandSchedulesRequest.items:type_name -> worker.ApplyBotCommandScheduleItem
	213, // 55: worker.ApplyBotCommandSchedulesResponse.results:type_name -> worker.ApplyBotCommandScheduleItemResult
	216, // 56: worker.ReleaseBotCommandSchedulesRequest.items:type_name -> worker.ReleaseBotCommandScheduleItem
	217, // 57: worker.ReleaseBotCommandSchedulesResponse.results:type_name -> worker.ReleaseBotCommandScheduleItemResult
	209, // 58: worker.CancelBotCommandScheduleItem.unresolved_occurrences:type_name -> worker.CommandOccurrenceRef
	220, // 59: worker.CancelBotCommandSchedulesRequest.items:type_name -> worker.CancelBotCommandScheduleItem
	221, // 60: worker.CancelBotCommandSchedulesResponse.results:type_name -> worker.CancelBotCommandScheduleItemResult
	0,   // 61: worker.WorkerService.Register:input_type -> worker.RegisterRequest
	6,   // 62: worker.WorkerService.Heartbeat:input_type -> worker.HeartbeatRequest
	4,   // 63: worker.WorkerService.FetchBotWorkerArchive:input_type -> worker.FetchBotWorkerArchiveRequest
	2,   // 64: worker.WorkerService.ReportCrashSnapshot:input_type -> worker.ReportCrashSnapshotRequest
	15,  // 65: worker.WorkerService.CreateInstance:input_type -> worker.CreateInstanceRequest
	18,  // 66: worker.WorkerService.ResyncInstances:input_type -> worker.ResyncInstancesRequest
	20,  // 67: worker.WorkerService.StartInstance:input_type -> worker.InstanceActionRequest
	20,  // 68: worker.WorkerService.StopInstance:input_type -> worker.InstanceActionRequest
	20,  // 69: worker.WorkerService.RestartInstance:input_type -> worker.InstanceActionRequest
	20,  // 70: worker.WorkerService.KillInstance:input_type -> worker.InstanceActionRequest
	20,  // 71: worker.WorkerService.PreflightStartInstance:input_type -> worker.InstanceActionRequest
	22,  // 72: worker.WorkerService.SendCommand:input_type -> worker.SendCommandRequest
	20,  // 73: worker.WorkerService.GetInstanceStatus:input_type -> worker.InstanceActionRequest
	25,  // 74: worker.WorkerService.ListInstances:input_type -> worker.ListInstancesRequest
	28,  // 75: worker.WorkerService.StreamInstanceEvents:input_type -> worker.StreamInstanceEventsRequest
	30,  // 76: worker.WorkerService.IssueTerminalToken:input_type -> worker.IssueTerminalTokenRequest
	32,  // 77: worker.WorkerService.ListFiles:input_type -> worker.ListFilesRequest
	39,  // 78: worker.WorkerService.ReadFile:input_type -> worker.ReadFileRequest
	41,  // 79: worker.WorkerService.WriteFile:input_type -> worker.WriteFileRequest
	43,  // 80: worker.WorkerService.DeleteFile:input_type -> worker.DeleteFileRequest
	45,  // 81: worker.WorkerService.RenameFile:input_type -> worker.RenameFileRequest
	35,  // 82: worker.WorkerService.CheckPathAccess:input_type -> worker.CheckPathAccessRequest
	37,  // 83: worker.WorkerService.ChmodPath:input_type -> worker.ChmodPathRequest
	47,  // 84: worker.WorkerService.DownloadArchive:input_type -> worker.DownloadArchiveRequest
	49,  // 85: worker.WorkerService.DownloadFile:input_type -> worker.DownloadFileRequest
	51,  // 86: worker.WorkerService.UploadFile:input_type -> worker.UploadFileChunk
	53,  // 87: worker.WorkerService.SearchFiles:input_type -> worker.SearchFilesRequest
	175, // 88: worker.WorkerService.ListArchiveEntries:input_type -> worker.ListArchiveEntriesRequest
	178, // 89: worker.WorkerService.ReadArchiveEntry:input_type -> worker.ReadArchiveEntryRequest
	180, // 90: worker.WorkerService.DecompileClass:input_type -> worker.DecompileClassRequest
	56,  // 91: worker.WorkerService.ListConfigFiles:input_type -> worker.ListConfigFilesRequest
	62,  // 92: worker.WorkerService.ReadConfig:input_type -> worker.ReadConfigRequest
	64,  // 93: worker.WorkerService.WriteConfig:input_type -> worker.WriteConfigRequest
	66,  // 94: worker.WorkerService.ValidateConfig:input_type -> worker.ValidateConfigRequest
	70,  // 95: worker.WorkerService.GetNodeMetrics:input_type -> worker.GetNodeMetricsRequest
	72,  // 96: worker.WorkerService.GetInstanceMetrics:input_type -> worker.GetInstanceMetricsRequest
	74,  // 97: worker.WorkerService.GetInstanceResourceSnapshot:input_type -> worker.GetInstanceResourceSnapshotRequest
	77,  // 98: worker.WorkerService.GetInstanceEnv:input_type -> worker.GetInstanceEnvRequest
	94,  // 99: worker.WorkerService.ListJDKs:input_type -> worker.ListJDKsRequest
	97,  // 100: worker.WorkerService.InstallJDK:input_type -> worker.InstallJDKRequest
	102, // 101: worker.WorkerService.RemoveJDK:input_type -> worker.RemoveJDKRequest
	98,  // 102: worker.WorkerService.JDKCatalog:input_type -> worker.JDKCatalogRequest
	120, // 103: worker.WorkerService.ProbeJDK:input_type -> worker.ProbeJDKRequest
	122, // 104: worker.WorkerService.ScanRuntimes:input_type -> worker.ScanRuntimesRequest
	125, // 105: worker.WorkerService.InstallRuntime:input_type -> worker.InstallRuntimeRequest
	127, // 106: worker.WorkerService.RemoveRuntime:input_type -> worker.RemoveRuntimeRequest
	130, // 107: worker.WorkerService.GetPMConfig:input_type -> worker.GetPMConfigRequest
	132, // 108: worker.WorkerService.SetPMConfig:input_type -> worker.SetPMConfigRequest
	135, // 109: worker.WorkerService.ListGlobalPackages:input_type -> worker.ListGlobalPackagesRequest
	137, // 110: worker.WorkerService.InstallGlobalPackage:input_type -> worker.InstallGlobalPackageRequest
	139, // 111: worker.WorkerService.RemoveGlobalPackage:input_type -> worker.RemoveGlobalPackageRequest
	104, // 112: worker.WorkerService.DownloadCore:input_type -> worker.DownloadCoreRequest
	106, // 113: worker.WorkerService.InstallForgeServer:input_type -> worker.InstallForgeServerRequest
	109, // 114: worker.WorkerService.ListArtifactCache:input_type -> worker.ListArtifactCacheRequest
	111, // 115: worker.WorkerService.EvictArtifactCache:input_type -> worker.EvictArtifactCacheRequest
	113, // 116: worker.WorkerService.ClearArtifactCache:input_type -> worker.ClearArtifactCacheRequest
	115, // 117: worker.WorkerService.SetArtifactCacheCap:input_type -> worker.SetArtifactCacheCapRequest
	117, // 118: worker.WorkerService.BrowseDir:input_type -> worker.BrowseDirRequest
	141, // 119: worker.WorkerService.DeployServerProbe:input_type -> worker.DeployServerProbeRequest
	143, // 120: worker.WorkerService.CloneWorkDir:input_type -> worker.CloneWorkDirRequest
	145, // 121: worker.WorkerService.RemoveInstance:input_type -> worker.RemoveInstanceRequest
	9,   // 122: worker.WorkerService.DisposeOrphanRuntime:input_type -> worker.DisposeOrphanRuntimeRequest
	147, // 123: worker.WorkerService.ListImages:input_type -> worker.ListImagesRequest
	150, // 124: worker.WorkerService.PullImage:input_type -> worker.PullImageRequest
	152, // 125: worker.WorkerService.RemoveImage:input_type -> worker.RemoveImageRequest
	156, // 126: worker.WorkerService.CreateBackup:input_type -> worker.CreateBackupRequest
	158, // 127: worker.WorkerService.RestoreBackup:input_type -> worker.RestoreBackupRequest
	160, // 128: worker.WorkerService.TestStorageBackend:input_type -> worker.TestStorageBackendRequest
	79,  // 129: worker.WorkerService.CreateBot:input_type -> worker.CreateBotRequest
	81,  // 130: worker.WorkerService.DeleteBot:input_type -> worker.DeleteBotRequest
	83,  // 131: worker.WorkerService.ListBots:input_type -> worker.ListBotsRequest
	86,  // 132: worker.WorkerService.SetBotBehavior:input_type -> worker.SetBotBehaviorRequest
	88,  // 133: worker.WorkerService.SendBotCommand:input_type -> worker.SendBotCommandRequest
	90,  // 134: worker.WorkerService.RunBotScript:input_type -> worker.RunBotScriptRequest
	92,  // 135: worker.WorkerService.StreamBotEvents:input_type -> worker.StreamBotEventsRequest
	191, // 136: worker.WorkerService.GetBotCapacity:input_type -> worker.GetBotCapacityRequest
	194, // 137: worker.WorkerService.ApplyBotBatch:input_type -> worker.ApplyBotBatchRequest
	197, // 138: worker.WorkerService.GetBotFleetSnapshot:input_type -> worker.GetBotFleetSnapshotRequest
	201, // 139: worker.WorkerService.StreamBotFleetEvents:input_type -> worker.StreamBotFleetEventsRequest
	205, // 140: worker.WorkerService.SignalBotActions:input_type -> worker.SignalBotActionsRequest
	214, // 141: worker.WorkerService.ApplyBotCommandSchedules:input_type -> worker.ApplyBotCommandSchedulesRequest
	218, // 142: worker.WorkerService.ReleaseBotCommandSchedules:input_type -> worker.ReleaseBotCommandSchedulesRequest
	222, // 143: worker.WorkerService.CancelBotCommandSchedules:input_type -> worker.CancelBotCommandSchedulesRequest
	162, // 144: worker.WorkerService.StreamPluginEvents:input_type -> worker.StreamPluginEventsRequest
	165, // 145: worker.WorkerService.SendPluginCommand:input_type -> worker.SendPluginCommandRequest
	167, // 146: worker.WorkerService.QueryServerState:input_type -> worker.QueryServerStateRequest
	169, // 147: worker.WorkerService.GetVersion:input_type -> worker.GetVersionRequest
	171, // 148: worker.WorkerService.CheckDocker:input_type -> worker.CheckDockerRequest
	173, // 149: worker.WorkerService.UpgradeWorker:input_type -> worker.UpgradeWorkerRequest
	182, // 150: worker.WorkerService.TerminalSession:input_type -> worker.TerminalFrame
	185, // 151: worker.WorkerService.InspectServerDir:input_type -> worker.InspectServerDirRequest
	189, // 152: worker.WorkerService.ImportServerDir:input_type -> worker.ImportServerDirRequest
	1,   // 153: worker.WorkerService.Register:output_type -> worker.RegisterResponse
	14,  // 154: worker.WorkerService.Heartbeat:output_type -> worker.HeartbeatResponse
	5,   // 155: worker.WorkerService.FetchBotWorkerArchive:output_type -> worker.FetchBotWorkerArchiveResponse
	3,   // 156: worker.WorkerService.ReportCrashSnapshot:output_type -> worker.ReportCrashSnapshotResponse
	17,  // 157: worker.WorkerService.CreateInstance:output_type -> worker.CreateInstanceResponse
	19,  // 158: worker.WorkerService.ResyncInstances:output_type -> worker.ResyncInstancesResponse
	21,  // 159: worker.WorkerService.StartInstance:output_type -> worker.InstanceActionResponse
	21,  // 160: worker.WorkerService.StopInstance:output_type -> worker.InstanceActionResponse
	21,  // 161: worker.WorkerService.RestartInstance:output_type -> worker.InstanceActionResponse
	21,  // 162: worker.WorkerService.KillInstance:output_type -> worker.InstanceActionResponse
	21,  // 163: worker.WorkerService.PreflightStartInstance:output_type -> worker.InstanceActionResponse
	23,  // 164: worker.WorkerService.SendCommand:output_type -> worker.SendCommandResponse
	24,  // 165: worker.WorkerService.GetInstanceStatus:output_type -> worker.GetInstanceStatusResponse
	26,  // 166: worker.WorkerService.ListInstances:output_type -> worker.ListInstancesResponse
	29,  // 167: worker.WorkerService.StreamInstanceEvents:output_type -> worker.InstanceEvent
	31,  // 168: worker.WorkerService.IssueTerminalToken:output_type -> worker.IssueTerminalTokenResponse
	33,  // 169: worker.WorkerService.ListFiles:output_type -> worker.ListFilesResponse
	40,  // 170: worker.WorkerService.ReadFile:output_type -> worker.ReadFileResponse
	42,  // 171: worker.WorkerService.WriteFile:output_type -> worker.WriteFileResponse
	44,  // 172: worker.WorkerService.DeleteFile:output_type -> worker.DeleteFileResponse
	46,  // 173: worker.WorkerService.RenameFile:output_type -> worker.RenameFileResponse
	36,  // 174: worker.WorkerService.CheckPathAccess:output_type -> worker.CheckPathAccessResponse
	38,  // 175: worker.WorkerService.ChmodPath:output_type -> worker.ChmodPathResponse
	48,  // 176: worker.WorkerService.DownloadArchive:output_type -> worker.DownloadArchiveChunk
	50,  // 177: worker.WorkerService.DownloadFile:output_type -> worker.DownloadFileChunk
	52,  // 178: worker.WorkerService.UploadFile:output_type -> worker.UploadFileResponse
	55,  // 179: worker.WorkerService.SearchFiles:output_type -> worker.SearchFilesResponse
	177, // 180: worker.WorkerService.ListArchiveEntries:output_type -> worker.ListArchiveEntriesResponse
	179, // 181: worker.WorkerService.ReadArchiveEntry:output_type -> worker.ReadArchiveEntryResponse
	181, // 182: worker.WorkerService.DecompileClass:output_type -> worker.DecompileClassResponse
	58,  // 183: worker.WorkerService.ListConfigFiles:output_type -> worker.ListConfigFilesResponse
	63,  // 184: worker.WorkerService.ReadConfig:output_type -> worker.ReadConfigResponse
	65,  // 185: worker.WorkerService.WriteConfig:output_type -> worker.WriteConfigResponse
	67,  // 186: worker.WorkerService.ValidateConfig:output_type -> worker.ValidateConfigResponse
	71,  // 187: worker.WorkerService.GetNodeMetrics:output_type -> worker.GetNodeMetricsResponse
	73,  // 188: worker.WorkerService.GetInstanceMetrics:output_type -> worker.GetInstanceMetricsResponse
	75,  // 189: worker.WorkerService.GetInstanceResourceSnapshot:output_type -> worker.GetInstanceResourceSnapshotResponse
	78,  // 190: worker.WorkerService.GetInstanceEnv:output_type -> worker.GetInstanceEnvResponse
	96,  // 191: worker.WorkerService.ListJDKs:output_type -> worker.ListJDKsResponse
	101, // 192: worker.WorkerService.InstallJDK:output_type -> worker.InstallJDKResponse
	103, // 193: worker.WorkerService.RemoveJDK:output_type -> worker.RemoveJDKResponse
	100, // 194: worker.WorkerService.JDKCatalog:output_type -> worker.JDKCatalogResponse
	121, // 195: worker.WorkerService.ProbeJDK:output_type -> worker.ProbeJDKResponse
	124, // 196: worker.WorkerService.ScanRuntimes:output_type -> worker.ScanRuntimesResponse
	126, // 197: worker.WorkerService.InstallRuntime:output_type -> worker.InstallRuntimeResponse
	128, // 198: worker.WorkerService.RemoveRuntime:output_type -> worker.RemoveRuntimeResponse
	131, // 199: worker.WorkerService.GetPMConfig:output_type -> worker.GetPMConfigResponse
	133, // 200: worker.WorkerService.SetPMConfig:output_type -> worker.SetPMConfigResponse
	136, // 201: worker.WorkerService.ListGlobalPackages:output_type -> worker.ListGlobalPackagesResponse
	138, // 202: worker.WorkerService.InstallGlobalPackage:output_type -> worker.InstallGlobalPackageResponse
	140, // 203: worker.WorkerService.RemoveGlobalPackage:output_type -> worker.RemoveGlobalPackageResponse
	105, // 204: worker.WorkerService.DownloadCore:output_type -> worker.DownloadCoreResponse
	107, // 205: worker.WorkerService.InstallForgeServer:output_type -> worker.InstallForgeServerResponse
	110, // 206: worker.WorkerService.ListArtifactCache:output_type -> worker.ListArtifactCacheResponse
	112, // 207: worker.WorkerService.EvictArtifactCache:output_type -> worker.EvictArtifactCacheResponse
	114, // 208: worker.WorkerService.ClearArtifactCache:output_type -> worker.ClearArtifactCacheResponse
	116, // 209: worker.WorkerService.SetArtifactCacheCap:output_type -> worker.SetArtifactCacheCapResponse
	119, // 210: worker.WorkerService.BrowseDir:output_type -> worker.BrowseDirResponse
	142, // 211: worker.WorkerService.DeployServerProbe:output_type -> worker.DeployServerProbeResponse
	144, // 212: worker.WorkerService.CloneWorkDir:output_type -> worker.CloneWorkDirResponse
	146, // 213: worker.WorkerService.RemoveInstance:output_type -> worker.RemoveInstanceResponse
	10,  // 214: worker.WorkerService.DisposeOrphanRuntime:output_type -> worker.DisposeOrphanRuntimeResponse
	149, // 215: worker.WorkerService.ListImages:output_type -> worker.ListImagesResponse
	151, // 216: worker.WorkerService.PullImage:output_type -> worker.PullImageResponse
	153, // 217: worker.WorkerService.RemoveImage:output_type -> worker.RemoveImageResponse
	157, // 218: worker.WorkerService.CreateBackup:output_type -> worker.CreateBackupResponse
	159, // 219: worker.WorkerService.RestoreBackup:output_type -> worker.RestoreBackupResponse
	161, // 220: worker.WorkerService.TestStorageBackend:output_type -> worker.TestStorageBackendResponse
	80,  // 221: worker.WorkerService.CreateBot:output_type -> worker.CreateBotResponse
	82,  // 222: worker.WorkerService.DeleteBot:output_type -> worker.DeleteBotResponse
	84,  // 223: worker.WorkerService.ListBots:output_type -> worker.ListBotsResponse
	87,  // 224: worker.WorkerService.SetBotBehavior:output_type -> worker.SetBotBehaviorResponse
	89,  // 225: worker.WorkerService.SendBotCommand:output_type -> worker.SendBotCommandResponse
	91,  // 226: worker.WorkerService.RunBotScript:output_type -> worker.RunBotScriptResponse
	93,  // 227: worker.WorkerService.StreamBotEvents:output_type -> worker.BotEvent
	192, // 228: worker.WorkerService.GetBotCapacity:output_type -> worker.GetBotCapacityResponse
	196, // 229: worker.WorkerService.ApplyBotBatch:output_type -> worker.ApplyBotBatchResponse
	200, // 230: worker.WorkerService.GetBotFleetSnapshot:output_type -> worker.GetBotFleetSnapshotResponse
	203, // 231: worker.WorkerService.StreamBotFleetEvents:output_type -> worker.BotFleetEvent
	207, // 232: worker.WorkerService.SignalBotActions:output_type -> worker.SignalBotActionsResponse
	215, // 233: worker.WorkerService.ApplyBotCommandSchedules:output_type -> worker.ApplyBotCommandSchedulesResponse
	219, // 234: worker.WorkerService.ReleaseBotCommandSchedules:output_type -> worker.ReleaseBotCommandSchedulesResponse
	223, // 235: worker.WorkerService.CancelBotCommandSchedules:output_type -> worker.CancelBotCommandSchedulesResponse
	163, // 236: worker.WorkerService.StreamPluginEvents:output_type -> worker.PluginEvent
	166, // 237: worker.WorkerService.SendPluginCommand:output_type -> worker.SendPluginCommandResponse
	168, // 238: worker.WorkerService.QueryServerState:output_type -> worker.QueryServerStateResponse
	170, // 239: worker.WorkerService.GetVersion:output_type -> worker.GetVersionResponse
	172, // 240: worker.WorkerService.CheckDocker:output_type -> worker.CheckDockerResponse
	174, // 241: worker.WorkerService.UpgradeWorker:output_type -> worker.UpgradeWorkerResponse
	182, // 242: worker.WorkerService.TerminalSession:output_type -> worker.TerminalFrame
	188, // 243: worker.WorkerService.InspectServerDir:output_type -> worker.InspectServerDirResponse
	190, // 244: worker.WorkerService.ImportServerDir:output_type -> worker.ImportServerDirResponse
	153, // [153:245] is the sub-list for method output_type
	61,  // [61:153] is the sub-list for method input_type
...
func file_proto_worker_proto_init() {
	...
	file_proto_worker_proto_msgTypes[182].OneofWrappers = []any{
		(*TerminalFrame_Open)(nil),
		(*TerminalFrame_Frame)(nil),
	}
	file_proto_worker_proto_msgTypes[203].OneofWrappers = []any{
