...
const file_proto_worker_proto_rawDesc = "" +
	...
	"\bevidence\x18\x01 \x03(\v2\x18.worker.InstanceEvidenceR\bevidence2\x83?\n" +
	"\rWorkerService\x12=\n" +
...
var file_proto_worker_proto_msgTypes = make([]protoimpl.MessageInfo, 240)
var file_proto_worker_proto_goTypes = []any{
	...
	(*ReportOrphanAuditRequest)(nil),            // 4: worker.ReportOrphanAuditRequest
	(*ReportOrphanAuditResponse)(nil),           // 5: worker.ReportOrphanAuditResponse
	(*FetchBotWorkerArchiveRequest)(nil),        // 6: worker.FetchBotWorkerArchiveRequest
	(*FetchBotWorkerArchiveResponse)(nil),       // 7: worker.FetchBotWorkerArchiveResponse
	(*HeartbeatRequest)(nil),                    // 8: worker.HeartbeatRequest
	(*TaskSnapshot)(nil),                        // 9: worker.TaskSnapshot
	(*InstanceState)(nil),                       // 10: worker.InstanceState
	(*DisposeOrphanRuntimeRequest)(nil),         // 11: worker.DisposeOrphanRuntimeRequest
	(*DisposeOrphanRuntimeResponse)(nil),        // 12: worker.DisposeOrphanRuntimeResponse
	(*InstanceMetricSample)(nil),                // 13: worker.InstanceMetricSample
	(*ProcessMetricSample)(nil),                 // 14: worker.ProcessMetricSample
	(*ManagedRuntimeSnapshot)(nil),              // 15: worker.ManagedRuntimeSnapshot
	(*HeartbeatResponse)(nil),                   // 16: worker.HeartbeatResponse
	(*CreateInstanceRequest)(nil),               // 17: worker.CreateInstanceRequest
	(*PortMapping)(nil),                         // 18: worker.PortMapping
	(*CreateInstanceResponse)(nil),              // 19: worker.CreateInstanceResponse
	(*ResyncInstancesRequest)(nil),              // 20: worker.ResyncInstancesRequest
	(*ResyncInstancesResponse)(nil),             // 21: worker.ResyncInstancesResponse
	(*InstanceActionRequest)(nil),               // 22: worker.InstanceActionRequest
	(*InstanceActionResponse)(nil),              // 23: worker.InstanceActionResponse
	(*ManagedProcessInspectRequest)(nil),        // 24: worker.ManagedProcessInspectRequest
	(*ManagedProcessActionRequest)(nil),         // 25: worker.ManagedProcessActionRequest
	(*ManagedProcessInfo)(nil),                  // 26: worker.ManagedProcessInfo
	(*ManagedProcessInspectResponse)(nil),       // 27: worker.ManagedProcessInspectResponse
	(*ManagedProcessActionResponse)(nil),        // 28: worker.ManagedProcessActionResponse
	(*SendCommandRequest)(nil),                  // 29: worker.SendCommandRequest
	(*SendCommandResponse)(nil),                 // 30: worker.SendCommandResponse
	(*GetInstanceStatusResponse)(nil),           // 31: worker.GetInstanceStatusResponse
	(*ListInstancesRequest)(nil),                // 32: worker.ListInstancesRequest
	(*ListInstancesResponse)(nil),               // 33: worker.ListInstancesResponse
	(*InstanceInfo)(nil),                        // 34: worker.InstanceInfo
	(*StreamInstanceEventsRequest)(nil),         // 35: worker.StreamInstanceEventsRequest
	(*InstanceEvent)(nil),                       // 36: worker.InstanceEvent
	(*IssueTerminalTokenRequest)(nil),           // 37: worker.IssueTerminalTokenRequest
	(*IssueTerminalTokenResponse)(nil),          // 38: worker.IssueTerminalTokenResponse
	(*ListFilesRequest)(nil),                    // 39: worker.ListFilesRequest
	(*ListFilesResponse)(nil),                   // 40: worker.ListFilesResponse
	(*FileInfo)(nil),                            // 41: worker.FileInfo
	(*CheckPathAccessRequest)(nil),              // 42: worker.CheckPathAccessRequest
	(*CheckPathAccessResponse)(nil),             // 43: worker.CheckPathAccessResponse
	(*ChmodPathRequest)(nil),                    // 44: worker.ChmodPathRequest
	(*ChmodPathResponse)(nil),                   // 45: worker.ChmodPathResponse
	(*ReadFileRequest)(nil),                     // 46: worker.ReadFileRequest
	(*ReadFileResponse)(nil),                    // 47: worker.ReadFileResponse
	(*HashFileRequest)(nil),                     // 48: worker.HashFileRequest
	(*HashFileResponse)(nil),                    // 49: worker.HashFileResponse
	(*WriteFileRequest)(nil),                    // 50: worker.WriteFileRequest
	(*WriteFileResponse)(nil),                   // 51: worker.WriteFileResponse
	(*DeleteFileRequest)(nil),                   // 52: worker.DeleteFileRequest
	(*DeleteFileResponse)(nil),                  // 53: worker.DeleteFileResponse
	(*RenameFileRequest)(nil),                   // 54: worker.RenameFileRequest
	(*RenameFileResponse)(nil),                  // 55: worker.RenameFileResponse
	(*DownloadArchiveRequest)(nil),              // 56: worker.DownloadArchiveRequest
	(*DownloadArchiveChunk)(nil),                // 57: worker.DownloadArchiveChunk
	(*DownloadFileRequest)(nil),                 // 58: worker.DownloadFileRequest
	(*DownloadFileChunk)(nil),                   // 59: worker.DownloadFileChunk
	(*UploadFileChunk)(nil),                     // 60: worker.UploadFileChunk
	(*UploadFileResponse)(nil),                  // 61: worker.UploadFileResponse
	(*SearchFilesRequest)(nil),                  // 62: worker.SearchFilesRequest
	(*SearchHit)(nil),                           // 63: worker.SearchHit
	(*SearchFilesResponse)(nil),                 // 64: worker.SearchFilesResponse
	(*ListConfigFilesRequest)(nil),              // 65: worker.ListConfigFilesRequest
	(*ConfigFileInfo)(nil),                      // 66: worker.ConfigFileInfo
	(*ListConfigFilesResponse)(nil),             // 67: worker.ListConfigFilesResponse
	(*ConfigField)(nil),                         // 68: worker.ConfigField
	(*ValidationIssue)(nil),                     // 69: worker.ValidationIssue
	(*ConfigValidationResult)(nil),              // 70: worker.ConfigValidationResult
	(*ReadConfigRequest)(nil),                   // 71: worker.ReadConfigRequest
	(*ReadConfigResponse)(nil),                  // 72: worker.ReadConfigResponse
	(*WriteConfigRequest)(nil),                  // 73: worker.WriteConfigRequest
	(*WriteConfigResponse)(nil),                 // 74: worker.WriteConfigResponse
	(*ValidateConfigRequest)(nil),               // 75: worker.ValidateConfigRequest
	(*ValidateConfigResponse)(nil),              // 76: worker.ValidateConfigResponse
	(*DiffConfigRequest)(nil),                   // 77: worker.DiffConfigRequest
	(*DiffConfigResponse)(nil),                  // 78: worker.DiffConfigResponse
	(*GetNodeMetricsRequest)(nil),               // 79: worker.GetNodeMetricsRequest
	(*GetNodeMetricsResponse)(nil),              // 80: worker.GetNodeMetricsResponse
	(*GetInstanceMetricsRequest)(nil),           // 81: worker.GetInstanceMetricsRequest
	(*GetInstanceMetricsResponse)(nil),          // 82: worker.GetInstanceMetricsResponse
	(*GetInstanceResourceSnapshotRequest)(nil),  // 83: worker.GetInstanceResourceSnapshotRequest
	(*GetInstanceResourceSnapshotResponse)(nil), // 84: worker.GetInstanceResourceSnapshotResponse
	(*WorldMetric)(nil),                         // 85: worker.WorldMetric
	(*GetInstanceEnvRequest)(nil),               // 86: worker.GetInstanceEnvRequest
	(*GetInstanceEnvResponse)(nil),              // 87: worker.GetInstanceEnvResponse
	(*CreateBotRequest)(nil),                    // 88: worker.CreateBotRequest
	(*CreateBotResponse)(nil),                   // 89: worker.CreateBotResponse
	(*DeleteBotRequest)(nil),                    // 90: worker.DeleteBotRequest
	(*DeleteBotResponse)(nil),                   // 91: worker.DeleteBotResponse
	(*ListBotsRequest)(nil),                     // 92: worker.ListBotsRequest
	(*ListBotsResponse)(nil),                    // 93: worker.ListBotsResponse
	(*BotInfo)(nil),                             // 94: worker.BotInfo
	(*SetBotBehaviorRequest)(nil),               // 95: worker.SetBotBehaviorRequest
	(*SetBotBehaviorResponse)(nil),              // 96: worker.SetBotBehaviorResponse
	(*SendBotCommandRequest)(nil),               // 97: worker.SendBotCommandRequest
	(*SendBotCommandResponse)(nil),              // 98: worker.SendBotCommandResponse
	(*RunBotScriptRequest)(nil),                 // 99: worker.RunBotScriptRequest
	(*RunBotScriptResponse)(nil),                // 100: worker.RunBotScriptResponse
	(*StreamBotEventsRequest)(nil),              // 101: worker.StreamBotEventsRequest
	(*BotEvent)(nil),                            // 102: worker.BotEvent
	(*ListJDKsRequest)(nil),                     // 103: worker.ListJDKsRequest
	(*JDKInfo)(nil),                             // 104: worker.JDKInfo
	(*ListJDKsResponse)(nil),                    // 105: worker.ListJDKsResponse
	(*InstallJDKRequest)(nil),                   // 106: worker.InstallJDKRequest
	(*JDKCatalogRequest)(nil),                   // 107: worker.JDKCatalogRequest
	(*JDKCatalogPackage)(nil),                   // 108: worker.JDKCatalogPackage
	(*JDKCatalogResponse)(nil),                  // 109: worker.JDKCatalogResponse
	(*InstallJDKResponse)(nil),                  // 110: worker.InstallJDKResponse
	(*RemoveJDKRequest)(nil),                    // 111: worker.RemoveJDKRequest
	(*RemoveJDKResponse)(nil),                   // 112: worker.RemoveJDKResponse
	(*DownloadCoreRequest)(nil),                 // 113: worker.DownloadCoreRequest
	(*DownloadCoreResponse)(nil),                // 114: worker.DownloadCoreResponse
	(*InstallForgeServerRequest)(nil),           // 115: worker.InstallForgeServerRequest
	(*InstallForgeServerResponse)(nil),          // 116: worker.InstallForgeServerResponse
	(*FetchBinaryRequest)(nil),                  // 117: worker.FetchBinaryRequest
	(*FetchBinaryProgress)(nil),                 // 118: worker.FetchBinaryProgress
	(*ArtifactCacheItem)(nil),                   // 119: worker.ArtifactCacheItem
	(*ListArtifactCacheRequest)(nil),            // 120: worker.ListArtifactCacheRequest
	(*ListArtifactCacheResponse)(nil),           // 121: worker.ListArtifactCacheResponse
	(*EvictArtifactCacheRequest)(nil),           // 122: worker.EvictArtifactCacheRequest
	(*EvictArtifactCacheResponse)(nil),          // 123: worker.EvictArtifactCacheResponse
	(*ClearArtifactCacheRequest)(nil),           // 124: worker.ClearArtifactCacheRequest
	(*ClearArtifactCacheResponse)(nil),          // 125: worker.ClearArtifactCacheResponse
	(*SetArtifactCacheCapRequest)(nil),          // 126: worker.SetArtifactCacheCapRequest
	(*SetArtifactCacheCapResponse)(nil),         // 127: worker.SetArtifactCacheCapResponse
	(*BrowseDirRequest)(nil),                    // 128: worker.BrowseDirRequest
	(*BrowseDirEntry)(nil),                      // 129: worker.BrowseDirEntry
	(*BrowseDirResponse)(nil),                   // 130: worker.BrowseDirResponse
	(*ProbeJDKRequest)(nil),                     // 131: worker.ProbeJDKRequest
	(*ProbeJDKResponse)(nil),                    // 132: worker.ProbeJDKResponse
	(*ScanRuntimesRequest)(nil),                 // 133: worker.ScanRuntimesRequest
	(*RuntimeCandidate)(nil),                    // 134: worker.RuntimeCandidate
	(*ScanRuntimesResponse)(nil),                // 135: worker.ScanRuntimesResponse
	(*InstallRuntimeRequest)(nil),               // 136: worker.InstallRuntimeRequest
	(*InstallRuntimeResponse)(nil),              // 137: worker.InstallRuntimeResponse
	(*RemoveRuntimeRequest)(nil),                // 138: worker.RemoveRuntimeRequest
	(*RemoveRuntimeResponse)(nil),               // 139: worker.RemoveRuntimeResponse
	(*PMRegistry)(nil),                          // 140: worker.PMRegistry
	(*GetPMConfigRequest)(nil),                  // 141: worker.GetPMConfigRequest
	(*GetPMConfigResponse)(nil),                 // 142: worker.GetPMConfigResponse
	(*SetPMConfigRequest)(nil),                  // 143: worker.SetPMConfigRequest
	(*SetPMConfigResponse)(nil),                 // 144: worker.SetPMConfigResponse
	(*GlobalPackage)(nil),                       // 145: worker.GlobalPackage
	(*ListGlobalPackagesRequest)(nil),           // 146: worker.ListGlobalPackagesRequest
	(*ListGlobalPackagesResponse)(nil),          // 147: worker.ListGlobalPackagesResponse
	(*InstallGlobalPackageRequest)(nil),         // 148: worker.InstallGlobalPackageRequest
	(*InstallGlobalPackageResponse)(nil),        // 149: worker.InstallGlobalPackageResponse
	(*RemoveGlobalPackageRequest)(nil),          // 150: worker.RemoveGlobalPackageRequest
	(*RemoveGlobalPackageResponse)(nil),         // 151: worker.RemoveGlobalPackageResponse
	(*DeployServerProbeRequest)(nil),            // 152: worker.DeployServerProbeRequest
	(*DeployServerProbeResponse)(nil),           // 153: worker.DeployServerProbeResponse
	(*CloneWorkDirRequest)(nil),                 // 154: worker.CloneWorkDirRequest
	(*CloneWorkDirResponse)(nil),                // 155: worker.CloneWorkDirResponse
	(*RemoveInstanceRequest)(nil),               // 156: worker.RemoveInstanceRequest
	(*RemoveInstanceResponse)(nil),              // 157: worker.RemoveInstanceResponse
	(*ListImagesRequest)(nil),                   // 158: worker.ListImagesRequest
	(*ImageInfo)(nil),                           // 159: worker.ImageInfo
	(*ListImagesResponse)(nil),                  // 160: worker.ListImagesResponse
	(*PullImageRequest)(nil),                    // 161: worker.PullImageRequest
	(*PullImageResponse)(nil),                   // 162: worker.PullImageResponse
	(*RemoveImageRequest)(nil),                  // 163: worker.RemoveImageRequest
	(*RemoveImageResponse)(nil),                 // 164: worker.RemoveImageResponse
	(*StorageBackendSpec)(nil),                  // 165: worker.StorageBackendSpec
	(*BackupManifestEntry)(nil),                 // 166: worker.BackupManifestEntry
	(*CreateBackupRequest)(nil),                 // 167: worker.CreateBackupRequest
	(*CreateBackupResponse)(nil),                // 168: worker.CreateBackupResponse
	(*RestoreBackupRequest)(nil),                // 169: worker.RestoreBackupRequest
	(*RestoreBackupResponse)(nil),               // 170: worker.RestoreBackupResponse
	(*TestStorageBackendRequest)(nil),           // 171: worker.TestStorageBackendRequest
	(*TestStorageBackendResponse)(nil),          // 172: worker.TestStorageBackendResponse
	(*StreamPluginEventsRequest)(nil),           // 173: worker.StreamPluginEventsRequest
	(*PluginEvent)(nil),                         // 174: worker.PluginEvent
	(*PluginCommand)(nil),                       // 175: worker.PluginCommand
	(*SendPluginCommandRequest)(nil),            // 176: worker.SendPluginCommandRequest
	(*SendPluginCommandResponse)(nil),           // 177: worker.SendPluginCommandResponse
	(*QueryServerStateRequest)(nil),             // 178: worker.QueryServerStateRequest
	(*QueryServerStateResponse)(nil),            // 179: worker.QueryServerStateResponse
	(*GetVersionRequest)(nil),                   // 180: worker.GetVersionRequest
	(*GetVersionResponse)(nil),                  // 181: worker.GetVersionResponse
	(*CheckDockerRequest)(nil),                  // 182: worker.CheckDockerRequest
	(*CheckDockerResponse)(nil),                 // 183: worker.CheckDockerResponse
	(*UpgradeWorkerRequest)(nil),                // 184: worker.UpgradeWorkerRequest
	(*UpgradeWorkerResponse)(nil),               // 185: worker.UpgradeWorkerResponse
	(*ListArchiveEntriesRequest)(nil),           // 186: worker.ListArchiveEntriesRequest
	(*ArchiveEntry)(nil),                        // 187: worker.ArchiveEntry
	(*ListArchiveEntriesResponse)(nil),          // 188: worker.ListArchiveEntriesResponse
	(*ReadArchiveEntryRequest)(nil),             // 189: worker.ReadArchiveEntryRequest
	(*ReadArchiveEntryResponse)(nil),            // 190: worker.ReadArchiveEntryResponse
	(*DecompileClassRequest)(nil),               // 191: worker.DecompileClassRequest
	(*DecompileClassResponse)(nil),              // 192: worker.DecompileClassResponse
	(*TerminalFrame)(nil),                       // 193: worker.TerminalFrame
	(*TerminalOpen)(nil),                        // 194: worker.TerminalOpen
	(*TerminalWSFrame)(nil),                     // 195: worker.TerminalWSFrame
	(*InspectServerDirRequest)(nil),             // 196: worker.InspectServerDirRequest
	(*ImportJarCandidate)(nil),                  // 197: worker.ImportJarCandidate
	(*ImportJdkCandidate)(nil),                  // 198: worker.ImportJdkCandidate
	(*InspectServerDirResponse)(nil),            // 199: worker.InspectServerDirResponse
	(*ImportServerDirRequest)(nil),              // 200: worker.ImportServerDirRequest
	(*ImportServerDirResponse)(nil),             // 201: worker.ImportServerDirResponse
	(*GetBotCapacityRequest)(nil),               // 202: worker.GetBotCapacityRequest
	(*GetBotCapacityResponse)(nil),              // 203: worker.GetBotCapacityResponse
	(*BotAssignment)(nil),                       // 204: worker.BotAssignment
	(*ApplyBotBatchRequest)(nil),                // 205: worker.ApplyBotBatchRequest
	(*ApplyBotBatchItemResult)(nil),             // 206: worker.ApplyBotBatchItemResult
	(*ApplyBotBatchResponse)(nil),               // 207: worker.ApplyBotBatchResponse
	(*GetBotFleetSnapshotRequest)(nil),          // 208: worker.GetBotFleetSnapshotRequest
	(*BotPosition)(nil),                         // 209: worker.BotPosition
	(*BotRuntimeSnapshot)(nil),                  // 210: worker.BotRuntimeSnapshot
	(*GetBotFleetSnapshotResponse)(nil),         // 211: worker.GetBotFleetSnapshotResponse
	(*StreamBotFleetEventsRequest)(nil),         // 212: worker.StreamBotFleetEventsRequest
	(*BotActionEvent)(nil),                      // 213: worker.BotActionEvent
	(*BotFleetEvent)(nil),                       // 214: worker.BotFleetEvent
	(*BotActionSignal)(nil),                     // 215: worker.BotActionSignal
	(*SignalBotActionsRequest)(nil),             // 216: worker.SignalBotActionsRequest
	(*SignalBotActionItemResult)(nil),           // 217: worker.SignalBotActionItemResult
	(*SignalBotActionsResponse)(nil),            // 218: worker.SignalBotActionsResponse
	(*CommandOccurrenceKey)(nil),                // 219: worker.CommandOccurrenceKey
	(*CommandOccurrenceRef)(nil),                // 220: worker.CommandOccurrenceRef
	(*AppliedCommandOccurrence)(nil),            // 221: worker.AppliedCommandOccurrence
	(*AppliedCommandOccurrencePlan)(nil),        // 222: worker.AppliedCommandOccurrencePlan
	(*ApplyBotCommandScheduleItem)(nil),         // 223: worker.ApplyBotCommandScheduleItem
	(*ApplyBotCommandScheduleItemResult)(nil),   // 224: worker.ApplyBotCommandScheduleItemResult
	(*ApplyBotCommandSchedulesRequest)(nil),     // 225: worker.ApplyBotCommandSchedulesRequest
	(*ApplyBotCommandSchedulesResponse)(nil),    // 226: worker.ApplyBotCommandSchedulesResponse
	(*ReleaseBotCommandScheduleItem)(nil),       // 227: worker.ReleaseBotCommandScheduleItem
	(*ReleaseBotCommandScheduleItemResult)(nil), // 228: worker.ReleaseBotCommandScheduleItemResult
	(*ReleaseBotCommandSchedulesRequest)(nil),   // 229: worker.ReleaseBotCommandSchedulesRequest
	(*ReleaseBotCommandSchedulesResponse)(nil),  // 230: worker.ReleaseBotCommandSchedulesResponse
	(*CancelBotCommandScheduleItem)(nil),        // 231: worker.CancelBotCommandScheduleItem
	(*CancelBotCommandScheduleItemResult)(nil),  // 232: worker.CancelBotCommandScheduleItemResult
	(*CancelBotCommandSchedulesRequest)(nil),    // 233: worker.CancelBotCommandSchedulesRequest
	(*CancelBotCommandSchedulesResponse)(nil),   // 234: worker.CancelBotCommandSchedulesResponse
	(*ProbeInstanceEvidenceRequest)(nil),        // 235: worker.ProbeInstanceEvidenceRequest
	(*InstanceEvidence)(nil),                    // 236: worker.InstanceEvidence
	(*ProbeInstanceEvidenceResponse)(nil),       // 237: worker.ProbeInstanceEvidenceResponse
	nil,                                         // 238: worker.CreateInstanceRequest.EnvVarsEntry
	nil,                                         // 239: worker.GetInstanceEnvResponse.EnvEntry
}
var file_proto_worker_proto_depIdxs = []int32{
	10,  // 0: worker.HeartbeatRequest.instances:type_name -> worker.InstanceState
	13,  // 1: worker.HeartbeatRequest.instance_metrics:type_name -> worker.InstanceMetricSample
	9,   // 2: worker.HeartbeatRequest.tasks:type_name -> worker.TaskSnapshot
	14,  // 3: worker.HeartbeatRequest.process_metrics:type_name -> worker.ProcessMetricSample
	15,  // 4: worker.HeartbeatRequest.managed_runtime:type_name -> worker.ManagedRuntimeSnapshot
	85,  // 5: worker.InstanceMetricSample.worlds:type_name -> worker.WorldMetric
	238, // 6: worker.CreateInstanceRequest.env_vars:type_name -> worker.CreateInstanceRequest.EnvVarsEntry
	18,  // 7: worker.CreateInstanceRequest.port_mappings:type_name -> worker.PortMapping
	17,  // 8: worker.ResyncInstancesRequest.instances:type_name -> worker.CreateInstanceRequest
	26,  // 9: worker.ManagedProcessInspectResponse.target:type_name -> worker.ManagedProcessInfo
	26,  // 10: worker.ManagedProcessInspectResponse.children:type_name -> worker.ManagedProcessInfo
	26,  // 11: worker.ManagedProcessInspectResponse.ancestors:type_name -> worker.ManagedProcessInfo
	34,  // 12: worker.ListInstancesResponse.instances:type_name -> worker.InstanceInfo
	41,  // 13: worker.ListFilesResponse.files:type_name -> worker.FileInfo
	63,  // 14: worker.SearchFilesResponse.hits:type_name -> worker.SearchHit
	66,  // 15: worker.ListConfigFilesResponse.files:type_name -> worker.ConfigFileInfo
	69,  // 16: worker.ConfigValidationResult.issues:type_name -> worker.ValidationIssue
	68,  // 17: worker.ReadConfigResponse.fields:type_name -> worker.ConfigField
	70,  // 18: worker.ReadConfigResponse.validation:type_name -> worker.ConfigValidationResult
	68,  // 19: worker.WriteConfigRequest.fields:type_name -> worker.ConfigField
	70,  // 20: worker.WriteConfigResponse.validation:type_name -> worker.ConfigValidationResult
	70,  // 21: worker.ValidateConfigResponse.validation:type_name -> worker.ConfigValidationResult
	85,  // 22: worker.GetInstanceMetricsResponse.worlds:type_name -> worker.WorldMetric
	239, // 23: worker.GetInstanceEnvResponse.env:type_name -> worker.GetInstanceEnvResponse.EnvEntry
	94,  // 24: worker.ListBotsResponse.bots:type_name -> worker.BotInfo
	104, // 25: worker.ListJDKsResponse.jdks:type_name -> worker.JDKInfo
	108, // 26: worker.JDKCatalogResponse.packages:type_name -> worker.JDKCatalogPackage
	104, // 27: worker.InstallJDKResponse.jdk:type_name -> worker.JDKInfo
	119, // 28: worker.ListArtifactCacheResponse.items:type_name -> worker.ArtifactCacheItem
	129, // 29: worker.BrowseDirResponse.dirs:type_name -> worker.BrowseDirEntry
	134, // 30: worker.ScanRuntimesResponse.candidates:type_name -> worker.RuntimeCandidate
	140, // 31: worker.GetPMConfigResponse.registries:type_name -> worker.PMRegistry
	140, // 32: worker.SetPMConfigRequest.registries:type_name -> worker.PMRegistry
	145, // 33: worker.ListGlobalPackagesResponse.packages:type_name -> worker.GlobalPackage
	159, // 34: worker.ListImagesResponse.images:type_name -> worker.ImageInfo
	166, // 35: worker.CreateBackupRequest.base_manifest:type_name -> worker.BackupManifestEntry
	165, // 36: worker.CreateBackupRequest.storage:type_name -> worker.StorageBackendSpec
	166, // 37: worker.CreateBackupResponse.manifest:type_name -> worker.BackupManifestEntry
	165, // 38: worker.RestoreBackupRequest.storage:type_name -> worker.StorageBackendSpec
	165, // 39: worker.TestStorageBackendRequest.storage:type_name -> worker.StorageBackendSpec
	175, // 40: worker.SendPluginCommandRequest.command:type_name -> worker.PluginCommand
	187, // 41: worker.ListArchiveEntriesResponse.entries:type_name -> worker.ArchiveEntry
	194, // 42: worker.TerminalFrame.open:type_name -> worker.TerminalOpen
	195, // 43: worker.TerminalFrame.frame:type_name -> worker.TerminalWSFrame
	197, // 44: worker.InspectServerDirResponse.jars:type_name -> worker.ImportJarCandidate
	198, // 45: worker.InspectServerDirResponse.jdks:type_name -> worker.ImportJdkCandidate
	204, // 46: worker.ApplyBotBatchRequest.assignments:type_name -> worker.BotAssignment
	206, // 47: worker.ApplyBotBatchResponse.results:type_name -> worker.ApplyBotBatchItemResult
	209, // 48: worker.BotRuntimeSnapshot.pos:type_name -> worker.BotPosition
	210, // 49: worker.GetBotFleetSnapshotResponse.bots:type_name -> worker.BotRuntimeSnapshot
	210, // 50: worker.BotFleetEvent.runtime_snapshot:type_name -> worker.BotRuntimeSnapshot
	213, // 51: worker.BotFleetEvent.action_event:type_name -> worker.BotActionEvent
	215, // 52: worker.SignalBotActionsRequest.signals:type_name -> worker.BotActionSignal
	217, // 53: worker.SignalBotActionsResponse.results:type_name -> worker.SignalBotActionItemResult
	221, // 54: worker.AppliedCommandOccurrencePlan.occurrences:type_name -> worker.AppliedCommandOccurrence
	222, // 55: worker.ApplyBotCommandScheduleItem.plan:type_name -> worker.AppliedCommandOccurrencePlan
	219, // 56: worker.ApplyBotCommandScheduleItem.skip_occurrences:type_name -> worker.CommandOccurrenceKey
	223, // 57: worker.ApplyBotCommandSchedulesRequest.items:type_name -> worker.ApplyBotCommandScheduleItem
	224, // 58: worker.ApplyBotCommandSchedulesResponse.results:type_name -> worker.ApplyBotCommandScheduleItemResult
	227, // 59: worker.ReleaseBotCommandSchedulesRequest.items:type_name -> worker.ReleaseBotCommandScheduleItem
	228, // 60: worker.ReleaseBotCommandSchedulesResponse.results:type_name -> worker.ReleaseBotCommandScheduleItemResult
	220, // 61: worker.CancelBotCommandScheduleItem.unresolved_occurrences:type_name -> worker.CommandOccurrenceRef
	231, // 62: worker.CancelBotCommandSchedulesRequest.items:type_name -> worker.CancelBotCommandScheduleItem
	232, // 63: worker.CancelBotCommandSchedulesResponse.results:type_name -> worker.CancelBotCommandScheduleItemResult
	236, // 64: worker.ProbeInstanceEvidenceResponse.evidence:type_name -> worker.InstanceEvidence
	0,   // 65: worker.WorkerService.Register:input_type -> worker.RegisterRequest
	8,   // 66: worker.WorkerService.Heartbeat:input_type -> worker.HeartbeatRequest
	6,   // 67: worker.WorkerService.FetchBotWorkerArchive:input_type -> worker.FetchBotWorkerArchiveRequest
	2,   // 68: worker.WorkerService.ReportCrashSnapshot:input_type -> worker.ReportCrashSnapshotRequest
	4,   // 69: worker.WorkerService.ReportOrphanAudit:input_type -> worker.ReportOrphanAuditRequest
	17,  // 70: worker.WorkerService.CreateInstance:input_type -> worker.CreateInstanceRequest
	20,  // 71: worker.WorkerService.ResyncInstances:input_type -> worker.ResyncInstancesRequest
	22,  // 72: worker.WorkerService.StartInstance:input_type -> worker.InstanceActionRequest
	22,  // 73: worker.WorkerService.StopInstance:input_type -> worker.InstanceActionRequest
	22,  // 74: worker.WorkerService.RestartInstance:input_type -> worker.InstanceActionRequest
	22,  // 75: worker.WorkerService.KillInstance:input_type -> worker.InstanceActionRequest
	24,  // 76: worker.WorkerService.InspectManagedProcess:input_type -> worker.ManagedProcessInspectRequest
	25,  // 77: worker.WorkerService.TerminateManagedProcess:input_type -> worker.ManagedProcessActionRequest
	22,  // 78: worker.WorkerService.PreflightStartInstance:input_type -> worker.InstanceActionRequest
	22,  // 79: worker.WorkerService.AdoptForeignRuntime:input_type -> worker.InstanceActionRequest
	29,  // 80: worker.WorkerService.SendCommand:input_type -> worker.SendCommandRequest
	22,  // 81: worker.WorkerService.GetInstanceStatus:input_type -> worker.InstanceActionRequest
	32,  // 82: worker.WorkerService.ListInstances:input_type -> worker.ListInstancesRequest
	35,  // 83: worker.WorkerService.StreamInstanceEvents:input_type -> worker.StreamInstanceEventsRequest
	37,  // 84: worker.WorkerService.IssueTerminalToken:input_type -> worker.IssueTerminalTokenRequest
	39,  // 85: worker.WorkerService.ListFiles:input_type -> worker.ListFilesRequest
	46,  // 86: worker.WorkerService.ReadFile:input_type -> worker.ReadFileRequest
	48,  // 87: worker.WorkerService.HashFile:input_type -> worker.HashFileRequest
	50,  // 88: worker.WorkerService.WriteFile:input_type -> worker.WriteFileRequest
	52,  // 89: worker.WorkerService.DeleteFile:input_type -> worker.DeleteFileRequest
	54,  // 90: worker.WorkerService.RenameFile:input_type -> worker.RenameFileRequest
	42,  // 91: worker.WorkerService.CheckPathAccess:input_type -> worker.CheckPathAccessRequest
	44,  // 92: worker.WorkerService.ChmodPath:input_type -> worker.ChmodPathRequest
	56,  // 93: worker.WorkerService.DownloadArchive:input_type -> worker.DownloadArchiveRequest
	58,  // 94: worker.WorkerService.DownloadFile:input_type -> worker.DownloadFileRequest
	60,  // 95: worker.WorkerService.UploadFile:input_type -> worker.UploadFileChunk
	62,  // 96: worker.WorkerService.SearchFiles:input_type -> worker.SearchFilesRequest
	186, // 97: worker.WorkerService.ListArchiveEntries:input_type -> worker.ListArchiveEntriesRequest
	189, // 98: worker.WorkerService.ReadArchiveEntry:input_type -> worker.ReadArchiveEntryRequest
	191, // 99: worker.WorkerService.DecompileClass:input_type -> worker.DecompileClassRequest
	65,  // 100: worker.WorkerService.ListConfigFiles:input_type -> worker.ListConfigFilesRequest
	71,  // 101: worker.WorkerService.ReadConfig:input_type -> worker.ReadConfigRequest
	73,  // 102: worker.WorkerService.WriteConfig:input_type -> worker.WriteConfigRequest
	75,  // 103: worker.WorkerService.ValidateConfig:input_type -> worker.ValidateConfigRequest
	79,  // 104: worker.WorkerService.GetNodeMetrics:input_type -> worker.GetNodeMetricsRequest
	81,  // 105: worker.WorkerService.GetInstanceMetrics:input_type -> worker.GetInstanceMetricsRequest
	83,  // 106: worker.WorkerService.GetInstanceResourceSnapshot:input_type -> worker.GetInstanceResourceSnapshotRequest
	86,  // 107: worker.WorkerService.GetInstanceEnv:input_type -> worker.GetInstanceEnvRequest
	103, // 108: worker.WorkerService.ListJDKs:input_type -> worker.ListJDKsRequest
	106, // 109: worker.WorkerService.InstallJDK:input_type -> worker.InstallJDKRequest
	111, // 110: worker.WorkerService.RemoveJDK:input_type -> worker.RemoveJDKRequest
	107, // 111: worker.WorkerService.JDKCatalog:input_type -> worker.JDKCatalogRequest
	131, // 112: worker.WorkerService.ProbeJDK:input_type -> worker.ProbeJDKRequest
	133, // 113: worker.WorkerService.ScanRuntimes:input_type -> worker.ScanRuntimesRequest
	136, // 114: worker.WorkerService.InstallRuntime:input_type -> worker.InstallRuntimeRequest
	138, // 115: worker.WorkerService.RemoveRuntime:input_type -> worker.RemoveRuntimeRequest
	141, // 116: worker.WorkerService.GetPMConfig:input_type -> worker.GetPMConfigRequest
	143, // 117: worker.WorkerService.SetPMConfig:input_type -> worker.SetPMConfigRequest
	146, // 118: worker.WorkerService.ListGlobalPackages:input_type -> worker.ListGlobalPackagesRequest
	148, // 119: worker.WorkerService.InstallGlobalPackage:input_type -> worker.InstallGlobalPackageRequest
	150, // 120: worker.WorkerService.RemoveGlobalPackage:input_type -> worker.RemoveGlobalPackageRequest
	113, // 121: worker.WorkerService.DownloadCore:input_type -> worker.DownloadCoreRequest
	115, // 122: worker.WorkerService.InstallForgeServer:input_type -> worker.InstallForgeServerRequest
	117, // 123: worker.WorkerService.FetchBinary:input_type -> worker.FetchBinaryRequest
	120, // 124: worker.WorkerService.ListArtifactCache:input_type -> worker.ListArtifactCacheRequest
	122, // 125: worker.WorkerService.EvictArtifactCache:input_type -> worker.EvictArtifactCacheRequest
	124, // 126: worker.WorkerService.ClearArtifactCache:input_type -> worker.ClearArtifactCacheRequest
	126, // 127: worker.WorkerService.SetArtifactCacheCap:input_type -> worker.SetArtifactCacheCapRequest
	128, // 128: worker.WorkerService.BrowseDir:input_type -> worker.BrowseDirRequest
	152, // 129: worker.WorkerService.DeployServerProbe:input_type -> worker.DeployServerProbeRequest
	154, // 130: worker.WorkerService.CloneWorkDir:input_type -> worker.CloneWorkDirRequest
	156, // 131: worker.WorkerService.RemoveInstance:input_type -> worker.RemoveInstanceRequest
	11,  // 132: worker.WorkerService.DisposeOrphanRuntime:input_type -> worker.DisposeOrphanRuntimeRequest
	158, // 133: worker.WorkerService.ListImages:input_type -> worker.ListImagesRequest
	161, // 134: worker.WorkerService.PullImage:input_type -> worker.PullImageRequest
	163, // 135: worker.WorkerService.RemoveImage:input_type -> worker.RemoveImageRequest
	167, // 136: worker.WorkerService.CreateBackup:input_type -> worker.CreateBackupRequest
	169, // 137: worker.WorkerService.RestoreBackup:input_type -> worker.RestoreBackupRequest
	171, // 138: worker.WorkerService.TestStorageBackend:input_type -> worker.TestStorageBackendRequest
	88,  // 139: worker.WorkerService.CreateBot:input_type -> worker.CreateBotRequest
	90,  // 140: worker.WorkerService.DeleteBot:input_type -> worker.DeleteBotRequest
	92,  // 141: worker.WorkerService.ListBots:input_type -> worker.ListBotsRequest
	95,  // 142: worker.WorkerService.SetBotBehavior:input_type -> worker.SetBotBehaviorRequest
	97,  // 143: worker.WorkerService.SendBotCommand:input_type -> worker.SendBotCommandRequest
	99,  // 144: worker.WorkerService.RunBotScript:input_type -> worker.RunBotScriptRequest
	101, // 145: worker.WorkerService.StreamBotEvents:input_type -> worker.StreamBotEventsRequest
	202, // 146: worker.WorkerService.GetBotCapacity:input_type -> worker.GetBotCapacityRequest
	205, // 147: worker.WorkerService.ApplyBotBatch:input_type -> worker.ApplyBotBatchRequest
	208, // 148: worker.WorkerService.GetBotFleetSnapshot:input_type -> worker.GetBotFleetSnapshotRequest
	212, // 149: worker.WorkerService.StreamBotFleetEvents:input_type -> worker.StreamBotFleetEventsRequest
	216, // 150: worker.WorkerService.SignalBotActions:input_type -> worker.SignalBotActionsRequest
	225, // 151: worker.WorkerService.ApplyBotCommandSchedules:input_type -> worker.ApplyBotCommandSchedulesRequest
	229, // 152: worker.WorkerService.ReleaseBotCommandSchedules:input_type -> worker.ReleaseBotCommandSchedulesRequest
	233, // 153: worker.WorkerService.CancelBotCommandSchedules:input_type -> worker.CancelBotCommandSchedulesRequest
	173, // 154: worker.WorkerService.StreamPluginEvents:input_type -> worker.StreamPluginEventsRequest
	176, // 155: worker.WorkerService.SendPluginCommand:input_type -> worker.SendPluginCommandRequest
	178, // 156: worker.WorkerService.QueryServerState:input_type -> worker.QueryServerStateRequest
	180, // 157: worker.WorkerService.GetVersion:input_type -> worker.GetVersionRequest
	182, // 158: worker.WorkerService.CheckDocker:input_type -> worker.CheckDockerRequest
	184, // 159: worker.WorkerService.UpgradeWorker:input_type -> worker.UpgradeWorkerRequest
	193, // 160: worker.WorkerService.TerminalSession:input_type -> worker.TerminalFrame
	196, // 161: worker.WorkerService.InspectServerDir:input_type -> worker.InspectServerDirRequest
	200, // 162: worker.WorkerService.ImportServerDir:input_type -> worker.ImportServerDirRequest
	235, // 163: worker.WorkerService.ProbeInstanceEvidence:input_type -> worker.ProbeInstanceEvidenceRequest
	1,   // 164: worker.WorkerService.Register:output_type -> worker.RegisterResponse
	16,  // 165: worker.WorkerService.Heartbeat:output_type -> worker.HeartbeatResponse
	7,   // 166: worker.WorkerService.FetchBotWorkerArchive:output_type -> worker.FetchBotWorkerArchiveResponse
	3,   // 167: worker.WorkerService.ReportCrashSnapshot:output_type -> worker.ReportCrashSnapshotResponse
	5,   // 168: worker.WorkerService.ReportOrphanAudit:output_type -> worker.ReportOrphanAuditResponse
	19,  // 169: worker.WorkerService.CreateInstance:output_type -> worker.CreateInstanceResponse
	21,  // 170: worker.WorkerService.ResyncInstances:output_type -> worker.ResyncInstancesResponse
	23,  // 171: worker.WorkerService.StartInstance:output_type -> worker.InstanceActionResponse
	23,  // 172: worker.WorkerService.StopInstance:output_type -> worker.InstanceActionResponse
	23,  // 173: worker.WorkerService.RestartInstance:output_type -> worker.InstanceActionResponse
	23,  // 174: worker.WorkerService.KillInstance:output_type -> worker.InstanceActionResponse
	27,  // 175: worker.WorkerService.InspectManagedProcess:output_type -> worker.ManagedProcessInspectResponse
	28,  // 176: worker.WorkerService.TerminateManagedProcess:output_type -> worker.ManagedProcessActionResponse
	23,  // 177: worker.WorkerService.PreflightStartInstance:output_type -> worker.InstanceActionResponse
	23,  // 178: worker.WorkerService.AdoptForeignRuntime:output_type -> worker.InstanceActionResponse
	30,  // 179: worker.WorkerService.SendCommand:output_type -> worker.SendCommandResponse
	31,  // 180: worker.WorkerService.GetInstanceStatus:output_type -> worker.GetInstanceStatusResponse
	33,  // 181: worker.WorkerService.ListInstances:output_type -> worker.ListInstancesResponse
	36,  // 182: worker.WorkerService.StreamInstanceEvents:output_type -> worker.InstanceEvent
	38,  // 183: worker.WorkerService.IssueTerminalToken:output_type -> worker.IssueTerminalTokenResponse
	40,  // 184: worker.WorkerService.ListFiles:output_type -> worker.ListFilesResponse
	47,  // 185: worker.WorkerService.ReadFile:output_type -> worker.ReadFileResponse
	49,  // 186: worker.WorkerService.HashFile:output_type -> worker.HashFileResponse
	51,  // 187: worker.WorkerService.WriteFile:output_type -> worker.WriteFileResponse
	53,  // 188: worker.WorkerService.DeleteFile:output_type -> worker.DeleteFileResponse
	55,  // 189: worker.WorkerService.RenameFile:output_type -> worker.RenameFileResponse
	43,  // 190: worker.WorkerService.CheckPathAccess:output_type -> worker.CheckPathAccessResponse
	45,  // 191: worker.WorkerService.ChmodPath:output_type -> worker.ChmodPathResponse
	57,  // 192: worker.WorkerService.DownloadArchive:output_type -> worker.DownloadArchiveChunk
	59,  // 193: worker.WorkerService.DownloadFile:output_type -> worker.DownloadFileChunk
	61,  // 194: worker.WorkerService.UploadFile:output_type -> worker.UploadFileResponse
	64,  // 195: worker.WorkerService.SearchFiles:output_type -> worker.SearchFilesResponse
	188, // 196: worker.WorkerService.ListArchiveEntries:output_type -> worker.ListArchiveEntriesResponse
	190, // 197: worker.WorkerService.ReadArchiveEntry:output_type -> worker.ReadArchiveEntryResponse
	192, // 198: worker.WorkerService.DecompileClass:output_type -> worker.DecompileClassResponse
	67,  // 199: worker.WorkerService.ListConfigFiles:output_type -> worker.ListConfigFilesResponse
	72,  // 200: worker.WorkerService.ReadConfig:output_type -> worker.ReadConfigResponse
	74,  // 201: worker.WorkerService.WriteConfig:output_type -> worker.WriteConfigResponse
	76,  // 202: worker.WorkerService.ValidateConfig:output_type -> worker.ValidateConfigResponse
	80,  // 203: worker.WorkerService.GetNodeMetrics:output_type -> worker.GetNodeMetricsResponse
	82,  // 204: worker.WorkerService.GetInstanceMetrics:output_type -> worker.GetInstanceMetricsResponse
	84,  // 205: worker.WorkerService.GetInstanceResourceSnapshot:output_type -> worker.GetInstanceResourceSnapshotResponse
	87,  // 206: worker.WorkerService.GetInstanceEnv:output_type -> worker.GetInstanceEnvResponse
	105, // 207: worker.WorkerService.ListJDKs:output_type -> worker.ListJDKsResponse
	110, // 208: worker.WorkerService.InstallJDK:output_type -> worker.InstallJDKResponse
	112, // 209: worker.WorkerService.RemoveJDK:output_type -> worker.RemoveJDKResponse
	109, // 210: worker.WorkerService.JDKCatalog:output_type -> worker.JDKCatalogResponse
	132, // 211: worker.WorkerService.ProbeJDK:output_type -> worker.ProbeJDKResponse
	135, // 212: worker.WorkerService.ScanRuntimes:output_type -> worker.ScanRuntimesResponse
	137, // 213: worker.WorkerService.InstallRuntime:output_type -> worker.InstallRuntimeResponse
	139, // 214: worker.WorkerService.RemoveRuntime:output_type -> worker.RemoveRuntimeResponse
	142, // 215: worker.WorkerService.GetPMConfig:output_type -> worker.GetPMConfigResponse
	144, // 216: worker.WorkerService.SetPMConfig:output_type -> worker.SetPMConfigResponse
	147, // 217: worker.WorkerService.ListGlobalPackages:output_type -> worker.ListGlobalPackagesResponse
	149, // 218: worker.WorkerService.InstallGlobalPackage:output_type -> worker.InstallGlobalPackageResponse
	151, // 219: worker.WorkerService.RemoveGlobalPackage:output_type -> worker.RemoveGlobalPackageResponse
	114, // 220: worker.WorkerService.DownloadCore:output_type -> worker.DownloadCoreResponse
	116, // 221: worker.WorkerService.InstallForgeServer:output_type -> worker.InstallForgeServerResponse
	118, // 222: worker.WorkerService.FetchBinary:output_type -> worker.FetchBinaryProgress
	121, // 223: worker.WorkerService.ListArtifactCache:output_type -> worker.ListArtifactCacheResponse
	123, // 224: worker.WorkerService.EvictArtifactCache:output_type -> worker.EvictArtifactCacheResponse
	125, // 225: worker.WorkerService.ClearArtifactCache:output_type -> worker.ClearArtifactCacheResponse
	127, // 226: worker.WorkerService.SetArtifactCacheCap:output_type -> worker.SetArtifactCacheCapResponse
	130, // 227: worker.WorkerService.BrowseDir:output_type -> worker.BrowseDirResponse
	153, // 228: worker.WorkerService.DeployServerProbe:output_type -> worker.DeployServerProbeResponse
	155, // 229: worker.WorkerService.CloneWorkDir:output_type -> worker.CloneWorkDirResponse
	157, // 230: worker.WorkerService.RemoveInstance:output_type -> worker.RemoveInstanceResponse
	12,  // 231: worker.WorkerService.DisposeOrphanRuntime:output_type -> worker.DisposeOrphanRuntimeResponse
	160, // 232: worker.WorkerService.ListImages:output_type -> worker.ListImagesResponse
	162, // 233: worker.WorkerService.PullImage:output_type -> worker.PullImageResponse
	164, // 234: worker.WorkerService.RemoveImage:output_type -> worker.RemoveImageResponse
	168, // 235: worker.WorkerService.CreateBackup:output_type -> worker.CreateBackupResponse
	170, // 236: worker.WorkerService.RestoreBackup:output_type -> worker.RestoreBackupResponse
	172, // 237: worker.WorkerService.TestStorageBackend:output_type -> worker.TestStorageBackendResponse
	89,  // 238: worker.WorkerService.CreateBot:output_type -> worker.CreateBotResponse
	91,  // 239: worker.WorkerService.DeleteBot:output_type -> worker.DeleteBotResponse
	93,  // 240: worker.WorkerService.ListBots:output_type -> worker.ListBotsResponse
	96,  // 241: worker.WorkerService.SetBotBehavior:output_type -> worker.SetBotBehaviorResponse
	98,  // 242: worker.WorkerService.SendBotCommand:output_type -> worker.SendBotCommandResponse
	100, // 243: worker.WorkerService.RunBotScript:output_type -> worker.RunBotScriptResponse
	102, // 244: worker.WorkerService.StreamBotEvents:output_type -> worker.BotEvent
	203, // 245: worker.WorkerService.GetBotCapacity:output_type -> worker.GetBotCapacityResponse
	207, // 246: worker.WorkerService.ApplyBotBatch:output_type -> worker.ApplyBotBatchResponse
	211, // 247: worker.WorkerService.GetBotFleetSnapshot:output_type -> worker.GetBotFleetSnapshotResponse
	214, // 248: worker.WorkerService.StreamBotFleetEvents:output_type -> worker.BotFleetEvent
	218, // 249: worker.WorkerService.SignalBotActions:output_type -> worker.SignalBotActionsResponse
	226, // 250: worker.WorkerService.ApplyBotCommandSchedules:output_type -> worker.ApplyBotCommandSchedulesResponse
	230, // 251: worker.WorkerService.ReleaseBotCommandSchedules:output_type -> worker.ReleaseBotCommandSchedulesResponse
	234, // 252: worker.WorkerService.CancelBotCommandSchedules:output_type -> worker.CancelBotCommandSchedulesResponse
	174, // 253: worker.WorkerService.StreamPluginEvents:output_type -> worker.PluginEvent
	177, // 254: worker.WorkerService.SendPluginCommand:output_type -> worker.SendPluginCommandResponse
	179, // 255: worker.WorkerService.QueryServerState:output_type -> worker.QueryServerStateResponse
	181, // 256: worker.WorkerService.GetVersion:output_type -> worker.GetVersionResponse
	183, // 257: worker.WorkerService.CheckDocker:output_type -> worker.CheckDockerResponse
	185, // 258: worker.WorkerService.UpgradeWorker:output_type -> worker.UpgradeWorkerResponse
	193, // 259: worker.WorkerService.TerminalSession:output_type -> worker.TerminalFrame
	199, // 260: worker.WorkerService.InspectServerDir:output_type -> worker.InspectServerDirResponse
	201, // 261: worker.WorkerService.ImportServerDir:output_type -> worker.ImportServerDirResponse
	237, // 262: worker.WorkerService.ProbeInstanceEvidence:output_type -> worker.ProbeInstanceEvidenceResponse
	164, // [164:263] is the sub-list for method output_type
	65,  // [65:164] is the sub-list for method input_type
