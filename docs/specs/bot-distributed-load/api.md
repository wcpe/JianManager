...
- SignalBotActions：FR-363 Scenario 屏障/外部信号的 request/result 投递层；FR-369 命令计划、时间屏障释放与取消使用独立 `Apply/Release/CancelBotCommandSchedules` gRPC，再映射到独立 IPC
