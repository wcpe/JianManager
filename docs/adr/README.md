...
- [ADR-095](095-canonical-event-store-on-disk.md) canonical 事件体的落盘 compact 存储（FR-483，细化 ADR-094/FR-472 §4.3/§5.3 的存储介质）
- [ADR-094](094-worker-log-local-data-plane.md) Worker 日志本地数据面与 Control Plane 联邦查询（FR-472～483，**accepted**）
